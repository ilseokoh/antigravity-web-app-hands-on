...
[Node.js 다운로드 페이지](https://nodejs.org/ko/download)에 접속하여 Windows 환경 .msi 파일을 다운로드합니다. 

![Node.js 다운로드](./images/nodejs-download.png)

### 확인 

Windows Terminal 또는 Windows PowerShell 을 열어서 아래 명령으로 설치를 확인합니다. 

```
node --version
```

![Node version](./images/nodejs-version.png)
